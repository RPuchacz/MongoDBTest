...
/usr/bin/time -a -f "%e %U %S" -o time_results_replica.txt gunzip -c ~/Desktop/raporty/RS/Traffic_Violations.csv.gz | mongoimport --host carbon/localhost:27001 --drop --db Traffic_Violations --collection tickets --type csv --headerline
